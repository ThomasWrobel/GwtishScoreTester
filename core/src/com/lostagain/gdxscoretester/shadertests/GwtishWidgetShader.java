...
import com.lostagain.gdxscoretester.shadertests.GwtishWidgetShaderAttribute.TextScalingMode;
...
public class GwtishWidgetShader implements Shader {
	...
	public GwtishWidgetShader(Renderable renderable) {
		...
		String vert =  Gdx.files.internal("shadertests/gwtishwidgetshader_vert.glsl").readString();
		String frag =  Gdx.files.internal("shadertests/gwtishwidgetshader_frag.glsl").readString();
	...
	//	context.setBlending(true,GL20.GL_SRC_ALPHA ,GL20.GL_ONE_MINUS_SRC_ALPHA); //straight alpha
		...
		//instead we manually sort with z-index attributes
