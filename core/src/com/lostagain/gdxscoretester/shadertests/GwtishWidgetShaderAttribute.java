...
/**
 * a shader attribute that controls all style settings for the shader
 * 
...
*/
	...
	public String getDebugString() {
		String debug = "hasBCFilter:" + this.hasBCFilter()+"\n"
				+ "hasHSVFilter:" + this.hasHSVFilter()+"\n"
				+ "hasProcedralBackground:"+ this.hasProcedralBackground()+"\n"
