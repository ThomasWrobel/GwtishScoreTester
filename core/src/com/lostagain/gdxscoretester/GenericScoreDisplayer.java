...
public  class GenericScoreDisplayer extends Label implements Animating {
	...
	protected void updateDisplayedScoreVar(float secs) {
	...
	public  void updateVisualDisplayTo(double currentlyDisplayedScore2){
		this.setText(""+(long)currentlyDisplayedScore2);//convert to long as we dont want decimals
	}
